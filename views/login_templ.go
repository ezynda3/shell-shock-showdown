	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if app, ok := ctx.Value("app").(*pocketbase.PocketBase); ok {
			templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"relative flex min-h-screen items-center justify-center\"><!-- Full-screen background image --><div class=\"absolute inset-0 z-0\"><img src=\"/static/img/splash.png\" alt=\"Background\" class=\"h-full w-full object-cover\"><div class=\"absolute inset-0 bg-black/50 backdrop-blur-sm\"></div></div><!-- Semi-transparent card with login buttons --><div class=\"relative z-10 w-full max-w-md px-4\"><div class=\"rounded-xl border border-white/20 bg-black/40 p-8 backdrop-blur-md\"><div class=\"mb-6 text-center\"><h2 class=\"text-2xl font-bold leading-9 tracking-tight text-white\">Welcome Back</h2><p class=\"mt-2 text-sm text-white/70\">Sign in with your preferred provider</p></div><div id=\"oauth-providers\" class=\"grid grid-cols-1 gap-3\"><!-- Provider buttons will be populated here --></div></div></div></div>")
				if templ_7745c5c3_Err != nil {
