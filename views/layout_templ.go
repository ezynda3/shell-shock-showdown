		...
		if loggedIn {
			...
			if user := ctx.Value("user"); user != nil {
				if auth, ok := user.(*core.Record); ok {
					...
					templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(appURL + "/api/files/" + auth.BaseFilesPath() + "/" + auth.GetString("avatar"))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/layout.templ`, Line: 84, Col: 96}
					}
