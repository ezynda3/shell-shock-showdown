...
func Layout(loggedIn bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if loggedIn {
			...
			if user := ctx.Value("user"); user != nil {
				if auth, ok := user.(*core.Record); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/layout.templ`, Line: 81, Col: 108}
					}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<div class=\"uk-inline\"><button class=\"uk-btn uk-btn-default uk-btn-icon\" aria-label=\"Toggle theme\" onclick=\"toggleTheme()\"><uk-icon id=\"themeIcon\" icon=\"moon\"></uk-icon></button></div></div></nav></div></header><!-- Main Content --><main class=\"flex-1 overflow-auto\"><div class=\"uk-container uk-container-xl py-12\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</div></main><!-- Footer --><footer class=\"border-t border-border mt-20\"><div class=\"uk-container uk-container-xl py-8\"><div class=\"flex flex-col md:flex-row justify-between items-center gap-4\"><div class=\"text-sm text-muted-foreground\">© Franken UI. All rights reserved.</div><div class=\"flex gap-x-6\"><a href=\"/privacy\" class=\"text-sm text-muted-foreground hover:text-foreground\">Privacy Policy</a> <a href=\"/terms\" class=\"text-sm text-muted-foreground hover:text-foreground\">Terms of Service</a></div></div></div></footer></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
